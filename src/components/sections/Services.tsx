...
const services = [
  {
    ...
    description: 'Native iOS and Android apps with seamless performance and intuitive experiences.',
  },
  {
    icon: Database,
    title: 'Corporate & Enterprise Systems',
    description: 'Streamline operations with custom business automation and AI-powered solutions.',
  },
  {
    icon: Globe,
    title: 'Web Applications',
    description: 'Scalable SaaS platforms and portals built for speed, security, and growth.',
  },
  {
    icon: Layout,
    title: 'Websites',
    description: 'SEO-optimized, high-converting websites that elevate your brand.',
  },
]
